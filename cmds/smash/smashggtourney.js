...
module.exports = class SmashGGTourneyCommand extends Commando.Command {
  ...
  async run(message, {slug}) {
    ...
    desc += (d.state == 1) ? "has recently been created and is not active yet. " : (d.state == 2) ? "is currently active. " : "has been completed. ";
    ...
    var cil = `Primary Contact (${d.primaryContactType}): ${d.primaryContact}\n\n`;
    if (d.venueName !== null) {
